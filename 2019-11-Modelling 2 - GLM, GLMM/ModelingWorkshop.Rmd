...
4. Do one linear model for each region...data costly (e.g. Australia and North America have only two data points)
3. Try a linear mixed model

- B) How variable is the happiness between regions?

- C) How does happyness depend on other predictors such as health, economy and generosity?

### Some more visualization of the data

We can do some plots to see how data look like.
In this plot we visualize how economy affect happyness in every region. We could do one plot per predictor. 
