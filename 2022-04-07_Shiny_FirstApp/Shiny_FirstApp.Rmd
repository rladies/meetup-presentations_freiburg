...
Most reacivity happens within the `server` function. This is where input is turned into output!
...
- Create a new Shiny app that will serve as a party planner. Ask what food the host would like to serve as an text or select input, then ask how many guests there will be and how many portions of food using two slider inputs. Return how many portions each person will get.
