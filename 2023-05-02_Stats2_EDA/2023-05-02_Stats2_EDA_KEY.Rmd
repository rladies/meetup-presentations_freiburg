...
```{r}
artists %>% 
  summarise("average no. of MOMA exhibitions per year" = mean(moma_count_to_year),
            "sd MOMA" = sd(moma_count_to_year),
            "average no. of Whitney exhibitions per year" = mean(whitney_count_to_year),
            "sd Whitney" = sd(whitney_count_to_year))
```
